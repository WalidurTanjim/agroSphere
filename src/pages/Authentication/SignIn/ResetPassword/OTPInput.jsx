...
export default function () {
  const { email, otp, setPage } = useAuth();
...
console.log(email)
  ...
  return (
    <div className="flex justify-center items-center w-screen h-screen bg-gray-50  dark:bg-gray-900">
      <div className=" px-6 pt-10 pb-9 mx-auto w-full max-w-lg rounded-2xl bg-white shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
