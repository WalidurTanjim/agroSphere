...
const SignIn = () => {
  ...
  return (
    <div
      className={`flex flex-col md:flex-row-reverse gap-8 justify-center items-center min-h-[calc(100vh-200px)] overflow-x-hidden ${theme == "light" ? "from-blue-50 to-indigo-50" : "bg-gray-800"} p-4 py-10 `}
    >
      <div className="flex-1">
        <Lottie animationData={animationData} loop={true} className="px-4" />
      </div>
      <div className="flex justify-center items-center flex-1">
        ...
        >
          ...
          <div>
            ...
            <button
              type="submit"
              className={`w-full bg-slate-600 hover:bg-slate-800 hover:transition text-white py-2 rounded-lg mt-3 flex justify-center items-center ${isLocked ? "cursor-not-allowed opacity-50" : "cursor-pointer"}`}
