...
const SignUp = () => {
    ...
    try {
      ...
      if (data.image[0]) {
        ...
        updateUserProfile(Name, photo).then((res) => {
          ...
          axios.post("https://agro-sphere-server.vercel.app/users", userInfo).then((res) => {
            Swal.fire({
              position: "center",
              icon: "success",
  ...
  return (
    <div
      className={`flex flex-col md:flex-row gap-8 justify-center items-center min-h-screen overflow-x-hidden ${theme == "light" ? "from-blue-50 to-indigo-50" : "bg-gray-800"}  p-4 py-16`}
    >
          ...
          <div>
            ...
            <div class="space-y-2">
              ...
              <input
                type="file"
                name="image"
                class="w-full p-3 rounded-lg  border text-gray-900 file:bg-blue-200 hover:file:bg-blue-300 file:text-gray-900 file:border-0 file:p-2 file:rounded-md file:mr-4 file:cursor-pointer"
