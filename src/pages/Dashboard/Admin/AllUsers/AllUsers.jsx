import { ArrowUpAZ, CircleHelp } from "lucide-react";
...
const AllUsers = () => {
    ...
    return (
        <section className="all_users w-full min-h-screen">
            <DashboardRoutes />

            <div className="all_users_inner container mx-auto px-6 py-14">
                <h1 className="text-2xl md:text-3xl text-slate-700 mb-10 text-center">All Users In Here</h1>

                <div className="container px-4 mt-10 mx-auto">
                    <div className="flex items-center gap-x-3">
                        <h2 className="text-lg font-medium text-gray-800 dark:text-white">Total Members</h2>
                                        ...
                                        <thead className="bg-gray-50 dark:bg-gray-800">
                                            <tr>
                                                <th scope="col" className="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                    <div className="flex items-center gap-x-3"><span>Name</span></div>
                                                </th>

                                                <th scope="col" className="px-12 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                    <button className="flex items-center gap-x-2">
                                                        <span>Status</span> <ArrowUpAZ className="h-4" />
                                                    </button>
                                                </th>

                                                <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                    <button className="flex items-center gap-x-2">
                                                        <span>Role</span> <CircleHelp className="h-4" />
                                                    </button>
                                                </th>
