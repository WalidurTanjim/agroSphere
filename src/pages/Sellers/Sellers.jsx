            ...
            <div className="container mx-auto px-6 lg:px-48 py-14">
                ...
                <div className="container px-4 mt-10 mx-auto">
                    ...
                    <div className="flex items-center gap-x-3">
                        <h2 className="text-lg font-medium text-gray-800 dark:text-white">Total sellers</h2>

                        <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">{sellers.length > 0 ? sellers.length : 0} sellers</span>
                    </div>
                                ...
                                <div className="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                            {
                                                sellers?.map(seller => <SellerRow key={seller._id} seller={seller} />)
                                            }
                                        </tbody>
                                    </table>
                                </div>
